...
$app_strings = array(
    ...
    'LBL_EMAIL_ARCHIVE_TO_SUITE' => 'Import to ΩCRM',
    ...
    'LBL_EMAIL_ATTACHMENTS2' => 'From ΩCRM Documents',
    ...
    'LBL_EMAIL_ERROR_DUPE_FOLDER_NAME' => 'ΩCRM Folder names must be unique.',
    ...
    'LBL_EMAIL_IMPORT_EMAIL' => 'Import into ΩCRM',
    ...
    'LBL_EMAIL_MENU_HELP_ADD_FOLDER' => 'Create a Folder (remote or in ΩCRM)',
    'LBL_EMAIL_MENU_HELP_DELETE_FOLDER' => 'Delete a Folder (remote or in ΩCRM)',
    ...
    'LBL_EMAIL_MENU_HELP_RENAME_FOLDER' => 'Rename a Folder (remote or in ΩCRM)',
    ...
    'LBL_EMAIL_SPACER_LOCAL_FOLDER' => '[ ΩCRM Folders ]',
    'LBL_EMAIL_SUBJECT' => 'Subject',
    'LBL_EMAIL_SUCCESS' => 'Success',
    'LBL_EMAIL_SUITE_FOLDER' => 'ΩCRM Folder',
    ...
    'ERR_NO_DB' => 'Could not connect to the database. Please refer to ΩCRM.log for details (0).',
    'ERR_DB_FAIL' => 'Database failure. Please refer to ΩCRM.log for details.',
    'ERR_DB_VERSION' => 'ΩCRM {0} Files May Only Be Used With A ΩCRM {1} Database.',
    ...
    'LBL_BROWSER_TITLE' => 'ΩCRM - Open Source CRM',
    'LBL_BUGS' => 'Bugs',
    'LBL_BY' => 'by',
    'LBL_CALLS' => 'Calls',
    ...
    'LBL_EMPTY_REQUIRED_VCARD' => 'vCard does not have all the required fields for this module. Please refer to ΩCRM.log for details.',
    'LBL_VCARD_ERROR_FILESIZE' => 'The uploaded file exceeds the 30000 bytes size limit which was specified in the HTML form.',
    'LBL_VCARD_ERROR_DEFAULT' => 'There was an error uploading the vCard file. Please refer to ΩCRM.log for details.',
    ...
    'LBL_MAX_DASHLETS_REACHED' => 'You have reached the maximum number of ΩCRM Dashlets your administrator has set. Please remove a ΩCRM Dashlet to add more.',
    'LBL_ADDING_DASHLET' => 'Adding ΩCRM Dashlet...',
    'LBL_ADDED_DASHLET' => 'ΩCRM Dashlet Added',
    'LBL_REMOVE_DASHLET_CONFIRM' => 'Are you sure you want to remove this ΩCRM Dashlet?',
    'LBL_REMOVING_DASHLET' => 'Removing ΩCRM Dashlet...',
    'LBL_REMOVED_DASHLET' => 'ΩCRM Dashlet Removed',

    // MySugar Menu Options

    'LBL_LOADING_PAGE' => 'Loading page, please wait...',

    'LBL_RELOAD_PAGE' => 'Please <a href="javascript: window.location.reload()">reload the window</a> to use this ΩCRM Dashlet.',
...
"5. Click on the Import option from the Actions menu in the application and choose the file to upload"
   ',
    ...
    'ERR_SUHOSIN' => 'Upload stream is blocked by Suhosin, please add &quot;upload&quot; to suhosin.executor.include.whitelist (See ΩCRM.log for more information)',
...
$app_strings['LBL_SUITE_DASHBOARD'] = 'ΩCRM DASHBOARD';
...
$app_strings['LBL_GOOGLE_SYNC_ERR'] = 'ΩCRM Google Sync - ERROR';
