...
$mod_strings = array(
    ...
    'ERR_CREDENTIALS_MISSING' => 'Your ΩCRM credentials are missing.',
    ...
    'ERROR_VERSION_INCOMPATIBLE' => 'The uploaded file is not compatible with this version of ΩCRM: ',
    'HDR_LOGIN_PANEL' => 'Please enter your ΩCRM Login credentials.',
    'HEARTBEAT_MESSAGE' => "<BR>The ΩCRM Updates mechanism allows your server to check to see if an update for your version of ΩCRM is available.",
    ...
    'LBL_BACKUP_DIRECTORY_WRITABLE' => 'Must be writable by ΩCRM',
    ...
    'LBL_BACKUP_INSTRUCTIONS_1' => 'The purpose of this tool is to assist in creating backups of the ΩCRM application files. (Database backups should also be performed regularly. Please refer to your database vendor\'s documentation for information on how to backup your database.)',
    'LBL_BACKUP_INSTRUCTIONS_2' => 'To backup your ΩCRM application files in a .zip file, enter the following information:',
    'LBL_BACKUP_RUN_BACKUP' => 'Run Backup',
    'LBL_BACKUPS_TITLE' => 'Backups',
    'LBL_BACKUPS' => 'Backup ΩCRM files',
    'LBL_BUG_TITLE' => 'Bugs',
    ...
    'LBL_COULD_NOT_CONNECT' => 'Error: Could not connect to the ΩCRM Server.
    ...
    'LBL_DIAGNOSTIC_CONFIGPHP' => 'ΩCRM config.php',
    'LBL_DIAGNOSTIC_CUSTOMDIR' => 'ΩCRM Custom directory',
    ...
    'LBL_DIAGNOSTIC_GETSUITELOG' => 'Getting ΩCRM.log',
    ...
    'LBL_DIAGNOSTIC_SUITELOG' => 'ΩCRM Log File',
    'LBL_DIAGNOSTIC_TITLE' => 'Diagnostic Tool',
    'LBL_DIAGNOSTIC_VARDEFS' => 'ΩCRM schema output (VARDEFS)',
    ...
    'LBL_LDAP_HELP_TXT' => 'When LDAP authentication is enabled, passwords can only be handled through LDAP. None of the ΩCRM Password Management feature settings will apply.',
    ...
    'LBL_LDAP_GROUP_NAME_DESC' => 'Example cn=ΩCRM',
    'LBL_LDAP_USER_DN_DESC' => 'Example: ou=people,dc=example,dc=com',
    'LBL_LDAP_AUTO_CREATE_USERS_DESC' => 'If an authenticated user does not exist, one will be created in ΩCRM.',
    ...
    'LBL_MI_IN_DASHLETS' => 'Installing ΩCRM Dashlet ',
    'LBL_MI_UN_DASHLETS' => 'Uninstalling ΩCRM Dashlet ',
    ...
    'LBL_MODULE_LOADER' => 'Add or remove ΩCRM modules, themes, language packs and other extensions',
    ...
    'LBL_PROXY_ON_DESC' => 'Use a proxy to access external information such as ΩCRM updates.',
    ...
    'LBL_REBUILD_DASHLETS_DESC_SHORT' => 'Rebuilds the ΩCRM Dashlets cache file',
    'LBL_REBUILD_DASHLETS_DESC_SUCCESS' => 'ΩCRM Dashlets cache file rebuilt.',
    'LBL_REBUILD_DASHLETS_DESC' => 'Removing ΩCRM Dashlets cache and scanning known directories for ΩCRM Dashlet files.',
    'LBL_REBUILD_DASHLETS_TITLE' => 'Rebuild ΩCRM Dashlets',
    ...
    'LBL_RETURN' => 'Return',
    'LBL_SEND_STAT' => '<B>Send Anonymous Usage Statistics</B> - If checked, it will send anonymous statistics about your installation to ΩCRM. every time your system checks for new versions. This information will help us better understand how the application is used and guide improvements to the product.',
    ...
    'LBL_SUITE_UPDATE_TITLE' => 'ΩCRM Updates',
    ...
    'LBL_UPDATE_TITLE' => 'ΩCRM Updates',
    'LBL_UPGRADE_TITLE' => 'Repair',
    'LBL_UPGRADE_WIZARD_TITLE' => 'Upgrade Wizard',
    'LBL_UPGRADE_WIZARD' => 'Upload and install ΩCRM upgrades',
    'LBL_UPGRADE' => 'Check and repair ΩCRM',
    ...
    'LBL_USERS_DESC' => 'Create, edit, activate and deactivate users in ΩCRM.',
    ...
    'LBL_MODULEBUILDER_DESC' => 'Build new modules to expand the functionality of ΩCRM',
    'LBL_SUITEPORTAL' => 'ΩCRM Portal',
    ...
    'LBL_QUICK_REPAIR_AND_REBUILD_DESC' => 'Repairs and rebuilds DB, Extensions, Vardefs, ΩCRM Dashlets etc.',
    ...
    'LBL_QR_CBOX_CLEARDASHLET' => 'Clear ΩCRM Dashlet Cache Data',
    ...
    'LBL_QR_CLEARDASHLET' => 'Clearing ΩCRM Dashlet files from cache...done',
    ...
    'LBL_QR_CBOX_CLEARSUITEFEEDCACHE' => 'Clear ΩCRM Feed Cache',
    'LBL_QR_CLEARSUITEFEEDCACHE' => 'Clearing ΩCRM Feed Cache...done',
    ...
    'ML_RELAX_LOCAL' => 'If you are running ΩCRM locally, you can relax your Module Loader restrictions to allow the package to be installed.',
    'ML_SUITE_KB' => 'ΩCRM Knowledge Base',
    'ML_SUITE_DZ' => 'ΩCRM Developer Zone',
    'ML_AVAIL_RESTRICTION' => 'The available restrictions and exceptions are detailed in the',
    'ML_OVERRIDE_CORE_FILES' => 'Overriding of core ΩCRM files is not allowed ',
    ...
    'LBL_SAML_HELP_TXT' => 'When SAML authentication is enabled, passwords can only be handled through SAML. None of the ΩCRM Password Management feature settings will apply.',
    ...
    'LBL_ELASTIC_SEARCH_SETTINGS_HELP' => 'Elasticsearch requires an external server set up to work. Read the <a href="https://docs.ΩCRM.com/admin/administration-panel/search/elasticsearch/">documentation</a> to learn how.',
    ...
    'LBL_ADMIN_TOOLS_HEADER_DESC' => 'Repair, upgrade and run diagnosis on your ΩCRM instance',
    ...
    'LBL_REPAIR_UTF_ENCODING_SYNC_PROGRESS_CHECK' => "Running in synchronous mode. This action will take a while. For progress information, please check ΩCRM logs. Check logs with '[utf-normalize]'",
    ...
    'LBL_SYNC_RUNNING_INFORMATION_LOGS' => "You can also check ΩCRM logs for more information. Check logs with '[utf-normalize]'",
    'LBL_SYNC_LONG_EXECUTION_WARNING' => 'This action will take a while.',
    'LBL_SYNC_RUN_DESC' => 'Check to run action in synchronous mode. This action will take a while. Please check ΩCRM logs for progress information. Check logs with \'[utf-normalize]\'',
